...
**Ruta**: `/patients`
**Permiso requerido**: `list_patients`

[IMAGEN: Lista de pacientes con tabla completa]
...
**Causa**: La búsqueda no coincide con ningún registro
**Solución**:
...
**Causa**: El paciente tiene datos asociados (citas, presupuestos, pagos)
**Solución**:
...
**Causa**: Caracteres especiales o problemas de caché
**Solución**:
...
**Causa**: Ya hay un orden aplicado previamente
**Solución**:
...
- [Ver Datos del Paciente →](./09-tesoreria-vision-general) *(Próximamente)*
- [Expediente Clínico →](./10-administracion-vision-general) *(Próximamente)*

---

[← Volver: Visión General](./05-pacientes-vision-general) | [Siguiente: Agenda →](./07-agenda-vision-general)
