...
La **vista de lista de pacientes** es el punto de partida para acceder de manera rápida y ordenada a la información de todos los pacientes registrados en el sistema Oclü. Desde esta pantalla, el equipo de la clínica puede localizar, identificar y seleccionar a cualquier paciente para consultar o gestionar su información clínica, administrativa y financiera.

Esta vista está diseñada para facilitar la navegación dentro del sistema, optimizando el acceso a los datos y agilizando las tareas cotidianas del consultorio.
...
![Para El Chatcito 34](/images/Paraelchatcito34.png)
