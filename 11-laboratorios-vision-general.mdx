...
- [Gestión de Laboratorios →](./laboratorios.md)
- [Solicitudes de Laboratorio →](./solicitudes.md)
- [Control de Inventario →](./inventario.md)
- [Órdenes de Compra →](./ordenes.md)
- [Gestión de Proveedores →](./proveedores.md)

---

[← Volver: Administración](../06-administracion/vision-general.md) | [Siguiente: Multimedia →](../08-multimedia/vision-general.md)
