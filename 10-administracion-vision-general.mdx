...
- [Gestión de Personal →](./personal.md)
- [Configurar Horarios →](./horarios.md)
- [Asignar Permisos →](./permisos.md)
- [Crear Plantillas →](./plantillas.md)
- [Gestionar Categorías →](./categorias.md)

---

[← Volver: Tesorería](../05-tesoreria/vision-general.md) | [Siguiente: Gestión de Personal →](./personal.md)
