...
- **Desde la web** — Ingresás a la página de OCLÜ (https://www.oclucrm.com/) y hacés clic en **Solicitar demo**. El botón está visible apenas entrás al sitio y fijo en la esquina superior derecha. Al hacer clic, se abre directamente el formulario de registro.
...
Si no recordás tu contraseña, podés recuperarla desde la pantalla de login:

1. Hacé clic en **¿Olvidaste tu contraseña?**
2. Ingresá tu email
3. Hacé clic en **Enviar instrucciones**
4. Revisá tu correo y seguí los pasos indicados

> El email de recuperación llega al correo que tengas registrado en el sistema. Si no lo encontrás, revisá la carpeta de spam o correo no deseado.
...
- Combiná mayúsculas y minúsculas
- Incluí al menos un número
- Incluí al menos un carácter especial (!@#\$%)
- Evitá datos personales como tu nombre o fecha de nacimiento
- No la compartás con nadie
