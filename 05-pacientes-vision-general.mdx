...
**Ver más**: [Importar Pacientes desde Excel](./importar-pacientes.mdx)
...
**Ver más**: [Odontograma del Paciente](./odontograma.mdx)
...
**Ver más**: [Multimedia del Paciente](./multimedia.mdx)
