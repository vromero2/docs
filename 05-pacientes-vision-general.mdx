...
**Ver más**: [Importar Pacientes desde Excel](./06-pacientes-listar) *(Próximamente)*
...
**Ver más**: [Odontograma del Paciente](./07-agenda-vision-general) *(Próximamente)*
...
**Ver más**: [Multimedia del Paciente](./08-presupuestos-vision-general) *(Próximamente)*
...
- [Crear Nuevo Paciente →](./07-agenda-vision-general) *(Próximamente)*
- [Importar Pacientes desde Excel →](./08-presupuestos-vision-general) *(Próximamente)*
- [Expediente Clínico →](./09-tesoreria-vision-general) *(Próximamente)*
- [Odontograma →](./10-administracion-vision-general) *(Próximamente)*
- [Multimedia →](./11-laboratorios-vision-general) *(Próximamente)*
- [Presupuestos del Paciente →](./08-presupuestos-vision-general)
- [Balance y Pagos →](./09-tesoreria-vision-general) *(Próximamente)*

---

[← Volver: Roles y Permisos](./04-roles-permisos) | [Siguiente: Listar Pacientes →](./06-pacientes-listar)
