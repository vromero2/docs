...
**Ver más**: [Importar Pacientes desde Excel](./importar-pacientes.md)
...
**Ver más**: [Odontograma del Paciente](./odontograma.md)
...
**Ver más**: [Multimedia del Paciente](./multimedia.md)
...
- [Buscar y Listar Pacientes →](./listar-pacientes.md)
- [Crear Nuevo Paciente →](./crear-paciente.md)
- [Importar Pacientes desde Excel →](./importar-pacientes.md)
- [Expediente Clínico →](./expediente-clinico.md)
- [Odontograma →](./odontograma.md)
- [Multimedia →](./multimedia.md)
- [Presupuestos del Paciente →](../04-presupuestos/vision-general.md)
- [Balance y Pagos →](./balance.md)

---

[← Volver: Introducción](../01-introduccion/roles-permisos.md) | [Siguiente: Listar Pacientes →](./listar-pacientes.md)
