...
Actualmente no. Cada reporte se genera manualmente desde la pantalla de Ingresos o Egresos.

### ¿Quién puede ver estos reportes?

Depende de los permisos asignados al usuario. Generalmente, los usuarios con rol de **Administrador** o **Recepción** tienen acceso. Si no ves el módulo Finanzas, hablá con el administrador de tu clínica.