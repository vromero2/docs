...
Al hacer clic en Agregar clínica se abre un formulario dividido en dos secciones:
...
Al hacer clic en Agregar miembro se abre un formulario con los siguientes campos:
...
El formulario de edición incluye todos los campos del formulario de creación más los siguientes campos adicionales:
...
Desde el botón Configurar contratos se navega a una sección donde se gestionan los contratos de honorarios que definen cómo se liquida a cada profesional.
...
Al hacer clic en Agregar prestación se abre un formulario con los siguientes campos:
...
**Agregar/Editar un consentimiento** 

Al hacer clic en Agregar consentimiento o en el botón de editar se abre un formulario con los siguientes campos:
