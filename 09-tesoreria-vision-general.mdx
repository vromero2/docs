...
- [Dashboard de Tesorería →](./dashboard.md)
- [Registrar un Pago →](./registrar-pago.md)
- [Recibos de Pago →](./recibos.md)
- [Cajas y Bancos →](./cajas-bancos.md)
- [Gastos →](./gastos.md)
- [Reportes Financieros →](./reportes-financieros.md)

---

[← Volver: Presupuestos](../04-presupuestos/vision-general.md) | [Siguiente: Dashboard →](./dashboard.md)
