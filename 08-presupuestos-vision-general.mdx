...
- [Crear un Presupuesto →](./crear-presupuesto.md)
- [Odontograma en Presupuestos →](./odontograma-presupuesto.md)
- [Símbolos y Tratamientos →](./simbolos-tratamientos.md)
- [Evoluciones de Presupuesto →](./evoluciones.md)
- [Aprobar y Rechazar →](./aprobar-rechazar.md)

---

[← Volver: Agenda](../03-agenda/vision-general.md) | [Siguiente: Crear Presupuesto →](./crear-presupuesto.md)
