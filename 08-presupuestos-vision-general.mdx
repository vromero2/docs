...
- **Estado**: Pendiente, aprobado, eliminado, rechazado, cerrado, borrador
...
**Color**: Los diagnósticos se muestran en **AZUL** en el odontograma.

![Para El Chatcito 40](/images/Paraelchatcito40.png)
...
**Color**: Los tratamientos propuestos se muestran en **ROJO** en el odontograma.

![Para El Chatcito 39](/images/Paraelchatcito39.png)
...
![Para El Chatcito 41](/images/Paraelchatcito41.png)
...
- **Aprobado**: No se puede editar el plan, Solo puede cambiar a Cerrado si hay pagos.
- **Pendiente**: No editable
- **Eliminado**: No permite pagos, No se puede editar
